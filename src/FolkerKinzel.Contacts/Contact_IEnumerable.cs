...
public sealed partial class Contact : IEnumerable<Contact>
{
    ...
    /// zurückgibt.</see>
    /// </summary>
    /// <returns>Gibt einen Enumerator zurück, der die ausführende Instanz der <see cref="Contact">-Klasse selbst
    /// zurückgibt.</returns>
    /// <remarks>
    /// Diese Implementierung ermöglicht, ein einzelnes <see cref="Contact"-Objekt als Argument an einen Methodenparameter vom Typ
    ...
    /// zurückgibt.</see>
    /// </summary>
    /// <returns>Ein Enumerator, der die ausführende Instanz der <see cref="Contact">-Klasse selbst
    /// zurückgibt.</returns>
    /// <remarks>
    /// Diese Implementierung ermöglicht, ein einzelnes <see cref="Contact"-Objekt als Argument an einen Methodenparameter vom Typ
